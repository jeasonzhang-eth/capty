...
export function formatTimecode(seconds: number, format: TimecodeFormat): string {
...
export function exportSRT(_session: Session, segments: readonly Segment[]): string {
  return segments
    .map((segment, index) => {
...
export function exportMarkdown(session: Session, segments: readonly Segment[]): string {
